...
public class CopilotClientOptions {
     ...
     *
     * @return the models list handler, or {@code null} if not set
     */
     ...
     * 		() -> CompletableFuture.completedFuture(List.of(new ModelInfo().setId("my-model").setName("My Model"))));
     * }</pre>
     *
     * @param onListModels
     *            the handler that returns available models
     * @return this options instance for method chaining
     */
